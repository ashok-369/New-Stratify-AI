...
import { generateSalaryNegotiation } from '../services/geminiService.ts';
import { Icon } from './Icon.tsx';
import { SalaryScriptParams } from '../types.ts';
...
export const SalaryScriptTool = () => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const data = await generateSalaryNegotiation(params as SalaryScriptParams);
            setResult(data);
        } catch (err: any) {
