...
import { generatePersonas } from '../services/geminiService.ts';
import { Icon } from './Icon.tsx';
import { PersonaResult, PersonaParams } from '../types.ts';
...
const PersonaGeneratorTool = () => {
    ...
    const handleGenerate = async () => {
        ...
        setError(null);
        try {
            const personas = await generatePersonas(formData as PersonaParams);
            setResult(personas);
        } catch (err: any) {
