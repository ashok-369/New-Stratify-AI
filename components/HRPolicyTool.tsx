...
import { generateHRPolicy } from '../services/geminiService.ts';
import { Icon } from './Icon.tsx';
import { HRPolicyParams } from '../types.ts';
...
export const HRPolicyTool = () => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const rawText = await generateHRPolicy(params as HRPolicyParams);
