...
import { generateBrandingKit } from '../services/geminiService.ts';
import { Icon } from './Icon.tsx';
import { BrandingKitResult, BrandingKitParams } from '../types.ts';
...
const BrandingKitTool = () => {
    ...
    const [result, setResult] = useState<BrandingKitResult | null>(null);
    ...
    const handleGenerate = async () => {
        ...
        setError(null);
        try {
            const kit = await generateBrandingKit(formData as BrandingKitParams);
            setResult(kit);
        } catch (err: any) {
