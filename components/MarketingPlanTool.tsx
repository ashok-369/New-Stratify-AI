...
import { generateMarketingPlan } from '../services/geminiService.ts';
import { Icon } from './Icon.tsx';
import { MarketingPlanResult, MarketingPlanParams } from '../types.ts';
...
const MarketingPlanTool = () => {
    ...
    const handleGenerate = async () => {
        ...
        setError(null);
        try {
            const plan = await generateMarketingPlan(formData as MarketingPlanParams);
            setResult(plan);
        } catch (err: any) {
