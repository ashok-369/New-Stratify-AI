...
// 1. Tax Computation
export const TaxComputationTool: React.FC<ToolProps> = () => {
    ...
    const downloadPDF = () => {
        ...
        result.breakdown?.forEach((item: string) => {
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 mt-4 space-y-4 animate-in fade-in">
                    ...
                    <div className="bg-white p-4 rounded border border-gray-200">
                        ...
                        <ul className="list-disc ml-4 space-y-1 text-sm text-gray-700">
                            {result.breakdown?.map((item: string, i: number) => <li key={i}>{cleanText(item)}</li>)}
                        </ul>
                    </div>
...
export const InvestmentTracker: React.FC<ToolProps> = () => {
...
export const BudgetBuilder: React.FC<ToolProps> = () => {
...
export const ComplianceChecklist: React.FC<ToolProps> = () => {
    // ... (Same content) ...
...
export const AuditChecklist: React.FC<ToolProps> = () => {
    // ... (Same content) ...
...
// 6. Invoice Generator
export const InvoiceTool: React.FC<ToolProps> = () => {
