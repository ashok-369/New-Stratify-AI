...
import { generateOfferLetter } from '../services/geminiService.ts';
import { Icon } from './Icon.tsx';
import { OfferLetterParams } from '../types.ts';
...
export const OfferLetterTool = () => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const text = await generateOfferLetter(params as OfferLetterParams);
