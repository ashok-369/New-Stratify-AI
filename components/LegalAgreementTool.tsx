...
import { generateLegalAgreement } from '../services/geminiService.ts';
import { Icon } from './Icon.tsx';
import { LegalAgreementParams } from '../types.ts';
...
const LegalAgreementTool = () => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const docText = await generateLegalAgreement(formData as LegalAgreementParams);
